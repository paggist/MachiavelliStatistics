...
for players in [4,5,6,8,10,12,15]:
    data_to_write_to_file=[]
    filename="multi/machiagame_players"+str(players)+"_"+str(time.time())+".csv"
    ...
    write_csv("multi/machiagamem3solve_results.csv",[[result,resultrounds,elapsed_time,time.time()]],append=True)
